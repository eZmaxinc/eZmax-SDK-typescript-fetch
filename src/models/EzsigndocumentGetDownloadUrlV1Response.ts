...
import {
    ...
    EzsigndocumentGetDownloadUrlV1ResponseAllOfFromJSON,
    EzsigndocumentGetDownloadUrlV1ResponseAllOfFromJSONTyped,
    EzsigndocumentGetDownloadUrlV1ResponseAllOfToJSON,
