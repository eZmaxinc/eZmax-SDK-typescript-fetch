...
import {
    ...
    EzsigndocumentCreateObjectV1ResponseAllOfFromJSON,
    EzsigndocumentCreateObjectV1ResponseAllOfFromJSONTyped,
    EzsigndocumentCreateObjectV1ResponseAllOfToJSON,
