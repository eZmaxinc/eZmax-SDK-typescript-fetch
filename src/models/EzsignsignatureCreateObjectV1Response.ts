...
import {
    ...
    EzsignsignatureCreateObjectV1ResponseAllOfFromJSON,
    EzsignsignatureCreateObjectV1ResponseAllOfFromJSONTyped,
    EzsignsignatureCreateObjectV1ResponseAllOfToJSON,
