...
import {
    ...
    FranchisereferalincomeRequestCompoundAllOfFromJSON,
    FranchisereferalincomeRequestCompoundAllOfFromJSONTyped,
    FranchisereferalincomeRequestCompoundAllOfToJSON,
} from './';
...
export function FranchisereferalincomeRequestCompoundFromJSONTyped(json: any, ignoreDiscriminator: boolean): FranchisereferalincomeRequestCompound {
    ...
    return {
        ...
        'objAddress': AddressRequestFromJSON(json['objAddress']),
