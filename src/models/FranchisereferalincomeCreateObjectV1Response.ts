...
import {
    ...
    FranchisereferalincomeCreateObjectV1ResponseAllOfFromJSON,
    FranchisereferalincomeCreateObjectV1ResponseAllOfFromJSONTyped,
    FranchisereferalincomeCreateObjectV1ResponseAllOfToJSON,
