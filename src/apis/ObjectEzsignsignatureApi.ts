...
export class ObjectEzsignsignatureApi extends runtime.BaseAPI {
     ...
     */
    async ezsignsignatureCreateObjectV1Raw(requestParameters: EzsignsignatureCreateObjectV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<EzsignsignatureCreateObjectV1Response>> {
     ...
     * Create a new Ezsignsignature
     */
    async ezsignsignatureCreateObjectV1(requestParameters: EzsignsignatureCreateObjectV1OperationRequest, initOverrides?: RequestInit): Promise<EzsignsignatureCreateObjectV1Response> {
        const response = await this.ezsignsignatureCreateObjectV1Raw(requestParameters, initOverrides);
     ...
     */
    async ezsignsignatureDeleteObjectV1Raw(requestParameters: EzsignsignatureDeleteObjectV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<EzsignsignatureDeleteObjectV1Response>> {
     ...
     * Delete an existing Ezsignsignature
     */
    async ezsignsignatureDeleteObjectV1(requestParameters: EzsignsignatureDeleteObjectV1Request, initOverrides?: RequestInit): Promise<EzsignsignatureDeleteObjectV1Response> {
        const response = await this.ezsignsignatureDeleteObjectV1Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async ezsignsignatureGetChildrenV1Raw(requestParameters: EzsignsignatureGetChildrenV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.pkiEzsignsignatureID === null || requestParameters.pkiEzsignsignatureID === undefined) {
     ...
     * Retrieve an existing Ezsignsignature\'s children IDs
     */
    async ezsignsignatureGetChildrenV1(requestParameters: EzsignsignatureGetChildrenV1Request, initOverrides?: RequestInit): Promise<void> {
        await this.ezsignsignatureGetChildrenV1Raw(requestParameters, initOverrides);
    }
     ...
     */
    async ezsignsignatureGetObjectV1Raw(requestParameters: EzsignsignatureGetObjectV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<EzsignsignatureGetObjectV1Response>> {
        if (requestParameters.pkiEzsignsignatureID === null || requestParameters.pkiEzsignsignatureID === undefined) {
     ...
     * Retrieve an existing Ezsignsignature
     */
    async ezsignsignatureGetObjectV1(requestParameters: EzsignsignatureGetObjectV1Request, initOverrides?: RequestInit): Promise<EzsignsignatureGetObjectV1Response> {
        const response = await this.ezsignsignatureGetObjectV1Raw(requestParameters, initOverrides);
        return await response.value();
    }
