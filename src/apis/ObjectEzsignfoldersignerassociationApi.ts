...
export class ObjectEzsignfoldersignerassociationApi extends runtime.BaseAPI {
     ...
     */
    async ezsignfoldersignerassociationCreateObjectV1Raw(requestParameters: EzsignfoldersignerassociationCreateObjectV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<EzsignfoldersignerassociationCreateObjectV1Response>> {
     ...
     * Create a new Ezsignfoldersignerassociation
     */
    async ezsignfoldersignerassociationCreateObjectV1(requestParameters: EzsignfoldersignerassociationCreateObjectV1OperationRequest, initOverrides?: RequestInit): Promise<EzsignfoldersignerassociationCreateObjectV1Response> {
        const response = await this.ezsignfoldersignerassociationCreateObjectV1Raw(requestParameters, initOverrides);
     ...
     */
    async ezsignfoldersignerassociationDeleteObjectV1Raw(requestParameters: EzsignfoldersignerassociationDeleteObjectV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<EzsignfoldersignerassociationDeleteObjectV1Response>> {
     ...
     * Delete an existing Ezsignfoldersignerassociation
     */
    async ezsignfoldersignerassociationDeleteObjectV1(requestParameters: EzsignfoldersignerassociationDeleteObjectV1Request, initOverrides?: RequestInit): Promise<EzsignfoldersignerassociationDeleteObjectV1Response> {
        const response = await this.ezsignfoldersignerassociationDeleteObjectV1Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async ezsignfoldersignerassociationGetChildrenV1Raw(requestParameters: EzsignfoldersignerassociationGetChildrenV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.pkiEzsignfoldersignerassociationID === null || requestParameters.pkiEzsignfoldersignerassociationID === undefined) {
     ...
     * Retrieve an existing Ezsignfoldersignerassociation\'s children IDs
     */
    async ezsignfoldersignerassociationGetChildrenV1(requestParameters: EzsignfoldersignerassociationGetChildrenV1Request, initOverrides?: RequestInit): Promise<void> {
        await this.ezsignfoldersignerassociationGetChildrenV1Raw(requestParameters, initOverrides);
    }
     ...
     */
    async ezsignfoldersignerassociationGetInPersonLoginUrlV1Raw(requestParameters: EzsignfoldersignerassociationGetInPersonLoginUrlV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>> {
        if (requestParameters.pkiEzsignfoldersignerassociationID === null || requestParameters.pkiEzsignfoldersignerassociationID === undefined) {
     ...
     * Retrieve a Login Url to allow In-Person signing
     */
    async ezsignfoldersignerassociationGetInPersonLoginUrlV1(requestParameters: EzsignfoldersignerassociationGetInPersonLoginUrlV1Request, initOverrides?: RequestInit): Promise<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response> {
        const response = await this.ezsignfoldersignerassociationGetInPersonLoginUrlV1Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async ezsignfoldersignerassociationGetObjectV1Raw(requestParameters: EzsignfoldersignerassociationGetObjectV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<EzsignfoldersignerassociationGetObjectV1Response>> {
        if (requestParameters.pkiEzsignfoldersignerassociationID === null || requestParameters.pkiEzsignfoldersignerassociationID === undefined) {
     ...
     * Retrieve an existing Ezsignfoldersignerassociation
     */
    async ezsignfoldersignerassociationGetObjectV1(requestParameters: EzsignfoldersignerassociationGetObjectV1Request, initOverrides?: RequestInit): Promise<EzsignfoldersignerassociationGetObjectV1Response> {
        const response = await this.ezsignfoldersignerassociationGetObjectV1Raw(requestParameters, initOverrides);
        return await response.value();
    }
