...
export class ObjectFranchiseofficeApi extends runtime.BaseAPI {
     ...
     */
    async franchiseofficeGetAutocompleteV1Raw(requestParameters: FranchiseofficeGetAutocompleteV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CommonGetAutocompleteV1Response>> {
     ...
     * Retrieve Franchiseoffices and IDs
     */
    async franchiseofficeGetAutocompleteV1(requestParameters: FranchiseofficeGetAutocompleteV1Request, initOverrides?: RequestInit): Promise<CommonGetAutocompleteV1Response> {
        const response = await this.franchiseofficeGetAutocompleteV1Raw(requestParameters, initOverrides);
