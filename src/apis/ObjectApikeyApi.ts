...
export class ObjectApikeyApi extends runtime.BaseAPI {
     ...
     * Create a new Apikey
     */
    async apikeyCreateObjectV1Raw(requestParameters: ApikeyCreateObjectV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ApikeyCreateObjectV1Response>> {
     ...
     * Create a new Apikey
     */
    async apikeyCreateObjectV1(requestParameters: ApikeyCreateObjectV1OperationRequest, initOverrides?: RequestInit): Promise<ApikeyCreateObjectV1Response> {
        const response = await this.apikeyCreateObjectV1Raw(requestParameters, initOverrides);
