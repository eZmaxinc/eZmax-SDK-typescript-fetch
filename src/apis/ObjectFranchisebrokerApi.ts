...
export class ObjectFranchisebrokerApi extends runtime.BaseAPI {
     ...
     */
    async franchisebrokerGetAutocompleteV1Raw(requestParameters: FranchisebrokerGetAutocompleteV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CommonGetAutocompleteV1Response>> {
     ...
     * Retrieve Franchisebrokers and IDs
     */
    async franchisebrokerGetAutocompleteV1(requestParameters: FranchisebrokerGetAutocompleteV1Request, initOverrides?: RequestInit): Promise<CommonGetAutocompleteV1Response> {
        const response = await this.franchisebrokerGetAutocompleteV1Raw(requestParameters, initOverrides);
