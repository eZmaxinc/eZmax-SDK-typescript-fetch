...
export class ModuleAuthenticateApi extends runtime.BaseAPI {
     ...
     * Authenticate a user
     */
    async authenticateAuthenticateV2Raw(requestParameters: AuthenticateAuthenticateV2OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<AuthenticateAuthenticateV2Response>> {
     ...
     * Authenticate a user
     */
    async authenticateAuthenticateV2(requestParameters: AuthenticateAuthenticateV2OperationRequest, initOverrides?: RequestInit): Promise<AuthenticateAuthenticateV2Response> {
        const response = await this.authenticateAuthenticateV2Raw(requestParameters, initOverrides);
