...
export class ModuleUserApi extends runtime.BaseAPI {
     ...
     */
    async userCreateEzsignuserV1Raw(requestParameters: UserCreateEzsignuserV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UserCreateEzsignuserV1Response>> {
     ...
     * Create a new User of type Ezsignuser
     */
    async userCreateEzsignuserV1(requestParameters: UserCreateEzsignuserV1OperationRequest, initOverrides?: RequestInit): Promise<UserCreateEzsignuserV1Response> {
        const response = await this.userCreateEzsignuserV1Raw(requestParameters, initOverrides);
