...
export class ObjectActivesessionApi extends runtime.BaseAPI {
     ...
     */
    async activesessionGetCurrentV1Raw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<ActivesessionGetCurrentV1Response>> {
     ...
     * Get Current Activesession
     */
    async activesessionGetCurrentV1(initOverrides?: RequestInit): Promise<ActivesessionGetCurrentV1Response> {
        const response = await this.activesessionGetCurrentV1Raw(initOverrides);
