...
export class ModuleSsprApi extends runtime.BaseAPI {
     ...
     */
    async ssprResetPasswordRequestV1Raw(requestParameters: SsprResetPasswordRequestV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Reset Password Request
     */
    async ssprResetPasswordRequestV1(requestParameters: SsprResetPasswordRequestV1OperationRequest, initOverrides?: RequestInit): Promise<void> {
        await this.ssprResetPasswordRequestV1Raw(requestParameters, initOverrides);
    }
     ...
     * Reset Password
     */
    async ssprResetPasswordV1Raw(requestParameters: SsprResetPasswordV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Reset Password
     */
    async ssprResetPasswordV1(requestParameters: SsprResetPasswordV1OperationRequest, initOverrides?: RequestInit): Promise<void> {
        await this.ssprResetPasswordV1Raw(requestParameters, initOverrides);
    }
     ...
     * Send username(s)
     */
    async ssprSendUsernamesV1Raw(requestParameters: SsprSendUsernamesV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Send username(s)
     */
    async ssprSendUsernamesV1(requestParameters: SsprSendUsernamesV1OperationRequest, initOverrides?: RequestInit): Promise<void> {
        await this.ssprSendUsernamesV1Raw(requestParameters, initOverrides);
    }
     ...
     */
    async ssprUnlockAccountRequestV1Raw(requestParameters: SsprUnlockAccountRequestV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Unlock Account Request
     */
    async ssprUnlockAccountRequestV1(requestParameters: SsprUnlockAccountRequestV1OperationRequest, initOverrides?: RequestInit): Promise<void> {
        await this.ssprUnlockAccountRequestV1Raw(requestParameters, initOverrides);
    }
     ...
     * Unlock Account
     */
    async ssprUnlockAccountV1Raw(requestParameters: SsprUnlockAccountV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Unlock Account
     */
    async ssprUnlockAccountV1(requestParameters: SsprUnlockAccountV1OperationRequest, initOverrides?: RequestInit): Promise<void> {
        await this.ssprUnlockAccountV1Raw(requestParameters, initOverrides);
    }
     ...
     * Validate Token
     */
    async ssprValidateTokenV1Raw(requestParameters: SsprValidateTokenV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Validate Token
     */
    async ssprValidateTokenV1(requestParameters: SsprValidateTokenV1OperationRequest, initOverrides?: RequestInit): Promise<void> {
        await this.ssprValidateTokenV1Raw(requestParameters, initOverrides);
    }
