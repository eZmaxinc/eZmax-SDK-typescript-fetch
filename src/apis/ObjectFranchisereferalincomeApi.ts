...
export class ObjectFranchisereferalincomeApi extends runtime.BaseAPI {
     ...
     */
    async franchisereferalincomeCreateObjectV1Raw(requestParameters: FranchisereferalincomeCreateObjectV1OperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<FranchisereferalincomeCreateObjectV1Response>> {
     ...
     * Create a new Franchisereferalincome
     */
    async franchisereferalincomeCreateObjectV1(requestParameters: FranchisereferalincomeCreateObjectV1OperationRequest, initOverrides?: RequestInit): Promise<FranchisereferalincomeCreateObjectV1Response> {
        const response = await this.franchisereferalincomeCreateObjectV1Raw(requestParameters, initOverrides);
