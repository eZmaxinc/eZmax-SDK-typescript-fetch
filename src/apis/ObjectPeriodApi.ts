...
export class ObjectPeriodApi extends runtime.BaseAPI {
     ...
     */
    async periodGetAutocompleteV1Raw(requestParameters: PeriodGetAutocompleteV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CommonGetAutocompleteV1Response>> {
     ...
     * Retrieve Periods and IDs
     */
    async periodGetAutocompleteV1(requestParameters: PeriodGetAutocompleteV1Request, initOverrides?: RequestInit): Promise<CommonGetAutocompleteV1Response> {
        const response = await this.periodGetAutocompleteV1Raw(requestParameters, initOverrides);
