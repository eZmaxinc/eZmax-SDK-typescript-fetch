...
export class GlobalCustomerApi extends runtime.BaseAPI {
     ...
     */
    async globalCustomerGetEndpointV1Raw(requestParameters: GlobalCustomerGetEndpointV1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<GlobalCustomerGetEndpointV1Response>> {
     ...
     * Get customer endpoint
     */
    async globalCustomerGetEndpointV1(requestParameters: GlobalCustomerGetEndpointV1Request, initOverrides?: RequestInit): Promise<GlobalCustomerGetEndpointV1Response> {
        const response = await this.globalCustomerGetEndpointV1Raw(requestParameters, initOverrides);
